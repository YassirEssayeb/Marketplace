  ...
  return (
    <main className="pt-32 pb-20 max-w-container-max mx-auto px-margin-desktop min-h-screen">
      <div className="max-w-2xl mx-auto">
        ...
        <p className="font-body-md text-on-surface-variant mb-8">Have a question? Write to us.</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          <div className="bg-white p-6 rounded-xl border border-outline-variant text-center">
            ...
            <a href="mailto:contact@promarket.com" className="text-body-sm text-secondary hover:underline no-underline">contact@promarket.com</a>
          </div>
          <div className="bg-white p-6 rounded-xl border border-outline-variant text-center">
            <span className="material-symbols-outlined text-3xl text-secondary mb-3 block">phone</span>
            <h3 className="font-headline-sm text-headline-sm text-primary mb-1">Phone</h3>
          ...
          <div className="bg-white p-6 rounded-xl border border-outline-variant text-center">
            ...
            <h3 className="font-headline-sm text-headline-sm text-primary mb-1">Address</h3>
            <p className="text-body-sm text-on-surface-variant">New York, US</p>
          </div>
        </div>
          ...
          {sent ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="font-label-md text-label-md text-on-surface-variant uppercase tracking-wider mb-2 block">Name *</label>
                  <input
                    name="name"
              ...
              <div>
                <label className="font-label-md text-label-md text-on-surface-variant uppercase tracking-wider mb-2 block">Subject *</label>
                <input
                  name="subject"
