  ...
  return (
    <div className="page-container" style={{ maxWidth: '480px' }}>
      <div className="card-lg" style={{ marginTop: '2rem' }}>
        <h2 style={{ fontSize: '1.5rem', fontWeight: 800, marginBottom: '0.25rem' }}>Inscription</h2>
        ...
        <form onSubmit={handleSubmit}>
          <div className="form-group">
            ...
            <input name="name" placeholder="Jean Dupont" value={data.name} onChange={handleChange} required className="form-input" />
          </div>
          <div className="form-group">
            <label className="form-label">Email</label>
            <input name="email" type="email" placeholder="jean@exemple.fr" value={data.email} onChange={handleChange} required className="form-input" />
          </div>
          <div className="form-group">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
            <div className="form-group">
              ...
              <input name="phone" placeholder="06 XX XX XX XX" value={data.phone} onChange={handleChange} className="form-input" />
            </div>
            <div className="form-group">
              <label className="form-label">Ville</label>
              <input name="city" placeholder="Paris" value={data.city} onChange={handleChange} className="form-input" />
            </div>
          </div>
          <button type="submit" className="btn btn-success" style={{ width: '100%', padding: '0.75rem' }}>S'inscrire</button>
        </form>
